...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form class="form-inline" method="post" action="index.php?act=activar&usu=<?php echo $_GET['usu'];?>">
                <h1>¿Está seguro que desea activar la cuenta del usuario <?php echo $_GET['usu'] ?> ?</h1>
                Si desea activarlo, introduzca su contraseña y presione Continuar. 
