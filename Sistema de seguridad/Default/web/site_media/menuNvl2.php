    ...
    <div class="container-fluid">
      <div class="row" style="margin-top:30px;">
        <div class="col-md-8 col-md-offset-2 well">
          <div class="row" >
            <div class="col-md-4">
              <a href="#" class="btn btn-block" style="background:#333333; color:#BDBDBD"><span class="glyphicon glyphicon-tasks " style="color:#BDBDBD" > </span>&nbsp;&nbsp;Registrar Caución</a>
            </div>
            <div class="col-md-4">
          ...
          <div class="row" style="margin-top:5px;">
            <div class="col-md-4">
              <a href="#" class="btn btn-block" style="background:#333333; color:#BDBDBD"><span class="glyphicon glyphicon-edit " style="color:#BDBDBD" > </span>&nbsp;&nbsp;Registrar Notificación</a>
            </div>
            <div class="col-md-4">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <form action="#" method="post" id="form-buscar">
            <div class="form-group">
              <label for="búsqueda">búsqueda del detenido por:</label>
              <label class="radio-inline"><input type="radio" name="modo" value="1" checked onclick="$('#buscar').attr('placeholder','Cedula');">cedula</label>
              <label class="radio-inline"><input type="radio" name="modo" value="2" onclick="$('#buscar').attr('placeholder','Primer Nombre');">Primer nombre</label>

              <div class="input-group">
                <input type="text" name="búsqueda" class="form-control" placeholder="Cedula" id="buscar">
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="bs-callout bs-callout-warning">
            ...
            <p>
              A continuación se muestra una lista con los detenidos indocumentados. Como comprobar la veracidad de dichas personas en la lista se mostrará la fotografía de los detenidos<br>
...
<script type="text/javascript">
  ...
  var búsquedaSimple=function(search,tip){
    $.ajax({
      method:"POST",
      data:{ajax:4,búsqueda:search,tipo:tip}
    }).done(function(datos){
  ...
  var listaIndocumentados=function(){
    ...
    $(function(){
      $('#buscar').keydown(function(){
        ...
        búsquedaSimple($('#buscar').val(),$("input[name='modo']:checked").val());
      });
